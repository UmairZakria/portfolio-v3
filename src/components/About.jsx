...
const About = () => {
  ...
  return (
    <div className="projects mt-12 md:mt-[10vw] relative w-full flex items-center justify-center min-h-screen md:h-screen py-4 md:py-[1vw]">
      ...
      <div className="h-full w-full flex-1">
        ...
        >
          <div className="h-full w-full">
            <div className="flex w-full flex-wrap items-center justify-between font-confortaa mb-4 md:mb-0">
            ...
            <div className="flex flex-col md:flex-row justify-between mx-0 md:mx-[3vw] h-full gap-6 md:gap-0">
              <div className="relative h-full flex flex-col gap-4 md:gap-0 justify-evenly">
                <div
                  ...
                  className="w-full md:w-[350px] lg:w-[35vw] h-64 md:h-[25vw] rounded-lg md:rounded-[0.8vw]"
                >
                  <img
                ...
                <div className="project-text space-y-2 md:space-y-[0.4vw]">
                  <h1 className="text-3xl md:text-2xl lg:text-[3.2vw] font-Montserrat text-white">
              ...
              <div className="project-text py-4 md:py-6 lg:pt-[1vw] w-full md:w-[300px] lg:w-[30vw] h-full flex flex-col gap-4 md:gap-1 md:justify-around font-Montserrat">
                <div className="flex flex-wrap w-full items-start justify-between">
                  <div>
                    ...
                    <p className="text-xl md:text-lg lg:text-[1.6vw] text-white">{data[activeIndex].year}</p>
                  </div>
                  <div className="contthings">
                    <span className="relative z-[50] flex gap-3 transition-all duration-300 ease-in-out">
                      <motion.a className="relative !z-[100] items-center gap-1 text-sm md:text-[1vw] border-b transition-all duration-300 ease-in-out hover:text-white hover:border-white cursor-pointer border-prime2 text-prime2 inline-flex">
                        <ArrowUpRight className="w-4 h-4 md:w-[1vw] md:h-[1vw]" /> Learn More
                      </motion.a>
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="font-light text-white/90 font-Poppins text-sm md:text-xs lg:text-[1.1vw] leading-relaxed md:leading-[1.5vw]">
