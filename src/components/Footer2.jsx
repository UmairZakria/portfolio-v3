...
const Footer2 = () => {
  ...
  return (
    <>
      <div className="z-[100] flex flex-col items-center justify-between bg-[#ffffff04] relative px-4 md:px-[4vw] pt-4 md:pt-[2vw] lg:h-auto w-full backdrop-blur-xl font-Montserrat">
            ...
            <div className="gap-6 md:gap-[3vw] h-full flex flex-col justify-center items-start">
              <a href="https://www.umairlab.com/" title="Umair Lab" className="text-white">
                <h1 className="text-3xl md:text-[2.6vw] space-x-[0.2vw] pb-[0vw] font-bold tracking-tight border-white/20 items-end font-confortaa">
                  <span>.umair</span>
                  <span className="text-[0.45em] font-confortaa text-transparent bg-linear-to-tr from-[#b622a7] to-prime bg-clip-text">
                    lab
                  </span>
                </h1>
              </a>
